...
#1
p1 <- ggplot(cfps.fused.bristle.out, aes(x = weight_fcell, y = weight_mcell, label = type.post)) +
...
#2
p2 <- ggplot(cfps.fused.bristle.out, aes(x = normed.weight_fcell, y = normed.weight_mcell, label = type.post)) +
  geom_point(size = 1, alpha = 0.7) +
  geom_abline(intercept = 0, slope = 1, linetype = "dashed", color = "red") +
  coord_fixed() +
  labs(
...
#3
p3 <- ggplot(cfps.fused.out, aes(x = weight_fcell, y = weight_mcell, label = type.post)) +
  geom_point(size = 1, alpha = 0.7) +
  geom_abline(intercept = 0, slope = 1, linetype = "dashed", color = "red") +
  coord_fixed() +
  labs(
...
#4
p4 <- ggplot(cfps.fused.out, aes(x = normed.weight_fcell, y = normed.weight_mcell, label = type.post)) +
  geom_point(size = 1, alpha = 0.7) +
  geom_abline(intercept = 0, slope = 1, linetype = "dashed", color = "red") +
  coord_fixed() +
  labs(
